...
const pool = new AgentPool(configStore, { output: (payload) => { void server.sendNotification("agent/output", payload); }, state: (payload) => { void server.sendNotification("agent/state", payload); }, exit: (payload) => { void server.sendNotification("agent/exit", payload); }, error: (payload) => { void server.sendNotification("agent/error", payload); }, log: (payload) => { void server.sendNotification("sidecar/log", payload); } });
