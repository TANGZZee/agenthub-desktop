export default {
  ...
  setupDesc1:
    "Claw3D 是你的 Hermes 智能体的 3D 可视化环境。它让你可以看到智能体在交互式办公空间中工作。",
  ...
  softwareRenderingNotice:
    "GPU 崩溃后硬件加速已关闭，3D 办公室正在使用较慢的软件渲染。",
  softwareRenderingEnvNotice:
    "硬件加速已被 HERMES_DISABLE_GPU 禁用，3D 办公室正在使用较慢的软件渲染。",
  softwareRenderingPrefNotice:
    "已在设置 → 外观中关闭硬件加速，3D 办公室正在使用较慢的软件渲染。",
  reenableGpu: "重新启用 GPU 并重启",
  dismissNotice: "忽略",
  // One-to-one chat modal opened from the Office screen
  oneChat: {
    title: "智能体",
    offlineHint: "离线 — 启动网关后才能聊天",
    selectAgent: "选择一个智能体开始聊天",
    startWith: "与 {{name}} 开始对话",
    inputPlaceholder: "选择一个智能体…",
  ...
  repTotalBalance: "总余额",
  repBalancePlaceholder: "运行“查询余额”来加载该智能体的总额。",
  repLoadingBalance: "正在查询余额…",
  repErrorTitle: "请求失败",
  repRetry: "重试",
  repEmptyWalletTitle: "空钱包",
  repEmptyWalletBody: "此账户中还没有资金。",
  repLoading: "处理中…",
  repErrorGeneric: "出了点问题，请重试。",
  repStatusSignedOut: "请登录你的 Hermes 账户以使用银行。",
