...
export const CAMERA_PRESET_OVERVIEW_ZOOM_FACTOR = 0.85;
export const CAMERA_PRESET_CLOSEUP_ZOOM = 8;
export const CAMERA_PRESET_FOLLOW_ZOOM = 5;

// ── Work Status Overlay ─────────────────────────────────────
export const STATUS_FONT_SIZE_DEFAULT = 14;
export const STATUS_FONT_SIZE_MIN = 8;
export const STATUS_FONT_SIZE_MAX = 24;
export const STATUS_BG_PADDING_H = 4;
export const STATUS_BG_PADDING_V = 2;
export const STATUS_BG_COLOR = 'rgba(20, 20, 40, 0.75)';
export const STATUS_TEXT_COLOR = '#e0e0e0';
export const STATUS_BORDER_COLOR = 'rgba(100, 120, 200, 0.5)';
export const STATUS_MIN_ZOOM = 3;
export const STATUS_VERTICAL_OFFSET_PX = 28;

// ── Day/Night Cycle ─────────────────────────────────────────
export const DAY_NIGHT_TRANSPARENT = 'rgba(0, 0, 0, 0)';
/** Time-of-day overlay tints: [startHour, endHour, rgba color] */
export const DAY_NIGHT_PHASES: ReadonlyArray<{
  start: number;
  end: number;
  color: string;
}> = [
  { start: 6, end: 8, color: 'rgba(255, 180, 100, 0.08)' }, // Dawn — warm pink-orange
  { start: 8, end: 17, color: 'rgba(0, 0, 0, 0)' }, // Day — clear
  { start: 17, end: 19, color: 'rgba(255, 140, 50, 0.12)' }, // Dusk — warm orange
  { start: 19, end: 21, color: 'rgba(30, 40, 100, 0.18)' }, // Evening — blue
  { start: 21, end: 24, color: 'rgba(20, 15, 60, 0.25)' }, // Night/overtime — deep blue-purple
  { start: 0, end: 6, color: 'rgba(20, 15, 60, 0.25)' }, // Late night — deep blue-purple
];
