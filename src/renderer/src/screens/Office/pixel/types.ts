...
export type { ColorValue } from './ui-types';
...
export interface Character {
  ...
  /** Current index into path array (avoids O(n) shift) */
  pathIndex: number;
  ...
  folderName?: string;
  /** Direction to face after arriving at a POI target (set by npcManager) */
  arrivalDir?: Direction | null;
  /** Work status text shown above the character (e.g. "审查 API 逻辑...") */
  workStatus?: string | null;
  /** Timer for how long the current workStatus has been shown (counts down) */
  workStatusTimer?: number;
}
