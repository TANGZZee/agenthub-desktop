...
export interface TaskProposal { proposalId: string; title: string; description: string; proposedWorkerId: string; toolPolicy: string[]; writeScope: WriteScope; allowedPaths?: string[]; dependsOn?: string[]; budget?: { maxSeconds?: number; maxCost?: number }; model?: string; }
